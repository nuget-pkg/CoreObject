    ...
    IImportFromCommonJson
{
    ...
    {
        if (args.Length % 2 != 0)
            throw new ArgumentException("CoreObjectClassic.NewObject() requires even number arguments");
